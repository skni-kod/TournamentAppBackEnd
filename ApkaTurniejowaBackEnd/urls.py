...
urlpatterns = [
    ...
    url(r'^api/tournament_games/(?P<pk>\d+)/$', RoundViewSetDetail.as_view(), name='Tournament_Games'),
    url(r'^api/tournament_games/$', RoundViewSetList.as_view(), name='Tournament_Games'),
    ...
    url(r'^api/tournament_player_notifications/$', TournamentPlayerNotificationsViewSetList.as_view(), name='Tournament_Player_Notifications_List'),
    url(r'^api/tournament_player_notifications/(?P<pk>\d+)$', TournamentPlayerNotificationsViewSetDetail.as_view(), name='Tournament_Player_Notifications_Detail'),
